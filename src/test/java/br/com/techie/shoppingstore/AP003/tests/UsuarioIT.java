...
//                         .bodyValue(new UserSystemFORM("joao@Gmail.com", "JAVA!@#ResTIc18"))
//                         .exchange()
...
//                         .uri("/api/v1/usuarios")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemFORM("", "JAVA!@#ResTIc18"))
//                         .exchange()
...
//                         .uri("/api/v1/usuarios")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemFORM("tody@", "JAVA!@#ResTIc18"))
//                         .exchange()
//                         .expectStatus().isEqualTo(422)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
...
//                         .uri("/api/v1/usuarios")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemFORM("tody@email", "JAVA!@#ResTIc18"))
//                         .exchange()
//                         .expectStatus().isEqualTo(422)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
...
//                         .uri("/api/v1/usuarios")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemFORM("tody@gmail.com", "JAVA!@#ResTIc18fg444"))
//                         .exchange()
//                         .expectStatus().isEqualTo(422)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
...
//                         .uri("/api/v1/usuarios")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemFORM("ana@email.com", "JAVA!@#ResTIc18"))
//                         .exchange()
...
//                         .headers(JwtAuthentication.getHeaderAuthorization(testClient, "20191tadssaj0026@ifba.edu.br", "JAVA!@#ResTIc18"))
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemVIEW("JAVA!@#ResTIc18", "JAVA!@#ResTIc18", "JAVA!@#ResTIc18"))
//                         .exchange()
...
//                         .headers(JwtAuthentication.getHeaderAuthorization(testClient, "20191tadssaj0026@ifba.edu.br", "JAVA!@#ResTIc18"))
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemVIEW("JAVA!@#Res", "JAVA!@#Res", "JAVA!@#Res"))
//                         .exchange()
//                         .expectStatus().isEqualTo(422)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
...
//                         .headers(JwtAuthentication.getHeaderAuthorization(testClient, "20191tadssaj0026@ifba.edu.br", "JAVA!@#ResTIc18"))
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemVIEW("JAVA!@#ResTIc18456", "JAVA!@#ResTIc18456", "JAVA!@#ResTIc18456"))
//                         .exchange()
//                         .expectStatus().isEqualTo(422)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
...
//                         .headers(JwtAuthentication.getHeaderAuthorization(testClient, "20191tadssaj0026@ifba.edu.br", "JAVA!@#ResTIc18"))
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemVIEW("JAVA!@#ResTIc18", "JAVA!@#ResTIc18", "JAVA!@#ResTIc1"))
//                         .exchange()
...
//                         .headers(JwtAuthentication.getHeaderAuthorization(testClient, "20191tadssaj0026@ifba.edu.br", "JAVA!@#ResTIc18"))
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .bodyValue(new UserSystemVIEW("@#ResTIc18", "JAVA!@#ResTIc18", "JAVA!@#ResTIc18"))
//                         .exchange()
//                         .expectStatus().isEqualTo(400)
//                         .expectBody(ErrorMessage.class)
//                         .returnResult().getResponseBody();
